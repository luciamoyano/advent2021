...
const [giftsList, setGiftsList] = useState([
  {'name':'mundial de qatar 2022','quantity':1,'recipient':'Argentina','price':'0','image':'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTX6bWq0831ylJPM_pY5D5qPgCDdKJjSwT0gA&usqp=CAU'},
...
useEffect(()=>{
  ...
  return (
    ...
    <div className="App">
      <header>
        <h1>Whislist</h1>
        <div className='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lacus mauris. Sed fringilla consectetur nulla, at tincidunt leo varius vel. Nam vel ante eu justo euismod scelerisque. Nullam mi erat, imperdiet non sem id, malesuada interdum elit. Nunc a felis sit amet justo imperdiet luctus. In quis neque sapien.</div>
      </header>
      <main id="main-container">
        <Button id="delete-all" onClick={() => deleteAll()}type="reset" text="Borrar todos"/>
        <Button
        id="add-gift"
